...
import 'package:utopia_hooks_query/src/hooks/use_effect_event.dart';
...
int useIsFetching({
  ...
  // Recompute synchronously during build when filters change.
  final currentCount = computeCount.call();
  if (currentCount != count.value) count.value = currentCount;
